...
public class Main {
    ...
    private static MetricPublisher metricsPub = CloudWatchMetricPublisher
            .builder().namespace("SDK-Test-" + TABLE_NAME).cloudWatchClient(CloudWatchAsyncClient
                    .builder().httpClient(NettyNioAsyncHttpClient.builder().build()).build())
            .build();
